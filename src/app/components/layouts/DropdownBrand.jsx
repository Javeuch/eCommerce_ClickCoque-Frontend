...
const DropdownBrand = () => (
    <Dropdown>
        <DropdownToggle>
            <span className="flex bg-white text-black rounded px-6 py-2 font-medium">
                Marques
                <svg
        ...
        <DropdownMenu>
            <DropdownItem classname="dropdown-item">
                <Link to="/brand/huawei/8">Huawei</Link>
            </DropdownItem>
            <DropdownItem classname="dropdown-item">
                <Link to="/brand/samsung/1">Samsung</Link>
            </DropdownItem>
            <DropdownItem classname="dropdown-item">
                <Link to="/brand/xiaomi/11">Xiaomi</Link>
            </DropdownItem>
            <DropdownItem classname="dropdown-item">
                <Link to="/brand/apple/5">Apple</Link>
            </DropdownItem>
            <DropdownItem classname="dropdown-item">
                <Link to="/brand/sony/12">Sony</Link>
            </DropdownItem>
            <DropdownItem classname="dropdown-item">
                <Link to="/brand/google/4">Google</Link>
            </DropdownItem>
        </DropdownMenu>
    </Dropdown>
);
